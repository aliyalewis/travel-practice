...
ActiveRecord::Schema.define(version: 2019_07_31_022242) do
  ...
  create_table "bucket_lists", force: :cascade do |t|
    ...
    t.index ["country_id"], name: "index_bucket_lists_on_country_id"
  ...
  create_table "travel_logs", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["country_id"], name: "index_travel_logs_on_country_id"
